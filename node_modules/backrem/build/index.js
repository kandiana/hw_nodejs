...
var isSameColor_1 = require("./utils/isSameColor");
var replaceBackground = function (targetImageStream, backgroundImageStream, colorToReplace, threshold) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _a, backgroundImageRaw, targetImageRaw, newPixels, i, j, startIndex, pixel, needToReplacePixel, resultBuffer, readable;
                ...
                case 1:
                    ...
                    for (i = 0; i < targetImageRaw.info.height; i++) {
                        for (j = 0; j < targetImageRaw.info.width; j++) {
                            ...
                            needToReplacePixel = threshold === 0 ?
                                (0, isSameColor_1.isSameColor)(pixel, colorToReplace) :
                                (0, deltaE_1.deltaE)([pixel[0], pixel[1], pixel[2]], colorToReplace) < threshold;
